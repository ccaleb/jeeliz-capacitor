...
const JeelizThreeHelper = (function(){
  ...
  function update_poses(ds, threeCamera){
    ...
    console.log('threeCamera.aspect: ' + threeCamera.aspect + ', threeCamera.fov: ' + threeCamera.fov);
    ...
    _threeCompositeObjects.forEach(function(threeCompositeObject, i){
      ...
      // console.log('i: ' + i + ': ', threeCompositeObject.position);
  ...
  const that = {
    ...
    init: function(spec, detectCallback){
      ...
      if (spec.threeCanvasId){
        console.log('_isSeparateThreeCanvas = true');
        ...
        console.log('_isSeparateThreeCanvas = false');
    ...
    render: function(detectState, threeCamera){
      ...
      detect(ds);
      console.log('render() threeCamera: ', threeCamera);
      update_poses(ds, threeCamera);

      console.log('_isSeparateThreeCanvas: ', this._isSeparateThreeCanvas);
      if (_isSeparateThreeCanvas){
        console.log('_isSeparateThreeCanvas here');
        ...
        console.log('_isSeparateThreeCanvas NOT here');
    ...
    create_threejsOccluder: function(occluderURL, callback){
      ...
      new THREE.BufferGeometryLoader().load(occluderURL, function(occluderGeometry){
        ...
        occluderMesh.renderOrder = 1; // -1; //render first
    ...
    update_camera: function(threeCamera){
      ...
      console.log('_videoElement: ', _videoElement);
